...
export default class YouTubeDebugger extends React.Component {
   ...
   bitrateHandler = () => this.setState({settings: {...this.state.settings, bitrate: 12}});
   resolutionHandler = () => this.setState({ settings: {...this.state.settings, video: { resolution: '720p'}}});
